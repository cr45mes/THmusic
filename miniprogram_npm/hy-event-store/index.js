...
__DEFINE__(1658925595435, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1658925595436,"./event-store":1658925595437}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1658925595436, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1658925595437, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1658925595436,"./utils":1658925595438}; return __REQUIRE__(map[modId], modId); })
...
return __REQUIRE__(1658925595435);
})()
